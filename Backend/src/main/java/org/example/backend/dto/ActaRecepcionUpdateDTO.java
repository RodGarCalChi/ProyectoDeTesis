...
/**
 * DTO para actualizar datos generales del Acta de Recepción (sin productos)
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ActaRecepcionUpdateDTO {
    ...
    @Size(max = 100, message = "El actualizador no puede exceder 100 caracteres")
