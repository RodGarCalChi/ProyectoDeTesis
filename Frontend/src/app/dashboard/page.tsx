      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-gray-600">Dashboard - Inventario</span>
          </div>
          <div className="flex items-center gap-4">
            <span className="text-sm text-gray-600">Bienvenido, {user?.firstName}</span>
            <button
...
export default function DashboardPage() {
  return (
    <ProtectedRoute requiredRole={['Inventario', 'Jefe_Ejecutivas', 'Control']}>
      <DashboardContent />
    </ProtectedRoute>
  );
}